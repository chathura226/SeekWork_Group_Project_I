    ...
    <div class="sidebar-content-wrapper">
        ...
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li id="managemoderators">
                    <a href="<?= ROOT ?>/admin/managemoderators">
                ...
                <li id="manageadmins">
                    <a href="<?= ROOT ?>/admin/manageadmins">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" class="svg-icons">
