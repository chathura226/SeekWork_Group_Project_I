...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?=ucfirst(substr(Auth::getfirstName(),0,1))?>. <?=ucfirst(Auth::getlastName())?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?=ucfirst(Auth::getfirstName())?> <?=ucfirst(Auth::getlastName())?></h6>
              <span><?=ucfirst(Auth::getrole())?></span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/tasks">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?=ROOT?>/mytasks">
          <i class="bi bi-camera-reels"></i>
          <span>My Tasks</span>
        </a>
      </li>
