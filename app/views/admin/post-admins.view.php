...
<div class="pagetitle column-12">
      ...
      <nav>
        ...
        <ul class="breadcrumbs">
          ...
          <li class="breadcrumbs__item">
            <a href="<?=ROOT?>/admin/manageadmins" class="breadcrumbs__link">Manage Admins</a>
          </li>
          <li class="breadcrumbs__item">
            <a href="" class="breadcrumbs__link breadcrumbs__link--active">Add new Admin</a>
          </li>
        </ul>
      </nav>
</div><!-- End Page Title -->
...
<div class="tab-form row-6">
  ...
  <div class="myheader">
      <div class="active-login"><h2>New Admin</h2></div>
  </div>
  <div class="tab-body">
      <div class="active">
          <form method="post"> 
                ...
                <div class="form-input">
                    ...
                    <input value="<?= set_value('firstName')?>" class="<?= !empty($errors['firstName']) ? 'error-border' : '' ?>" type="text" name="firstName" id="firstName" placeholder="Enter admin's first name">
                ...
                <div class="form-input">
                    ...
                    <input value="<?= set_value('lastName')?>" class="<?= !empty($errors['lastName']) ? 'error-border' : '' ?>" type="text" name="lastName" id="lastName" placeholder="Enter admin's last name">
                ...
                <div class="form-input">
                    ...
                    <input value="<?= set_value('contactNo')?>" class="<?= !empty($errors['contactNo']) ? 'error-border' : '' ?>" type="tel" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"  name="contactNo" id="contactNo" placeholder="Enter admin's contact number ">
                ...
                <div class="form-input">
                    ...
                    <input value="<?= set_value('email')?>" class="<?= !empty($errors['email']) ? 'error-border' : '' ?>" type="text" name="email" id="email" placeholder="Enter admin's email address">
                ...
                <div class="form-input">
                    <button>Create the new admin account</button>
                </div>
