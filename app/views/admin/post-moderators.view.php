                ...
                <form method="post">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('firstName') ?>"
                               ...
                               name="firstName" id="firstName" placeholder="Enter moderator's first name">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('lastName') ?>"
                               ...
                               name="lastName" id="lastName" placeholder="Enter moderator's last name">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('address') ?>"
                               ...
                               name="address" id="address" placeholder="Enter moderator's address">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('contactNo') ?>"
                               ...
                               placeholder="Enter moderator's contact number ">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('email') ?>"
                               class="<?= !empty($errors['email']) ? 'error-border' : '' ?>" type="text" name="email"
                               id="email" placeholder="Enter moderator's email address">
