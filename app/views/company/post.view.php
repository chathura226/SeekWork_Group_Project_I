                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= ucfirst(Auth::getcompanyName()) ?>"
                               ...
                               name="companyName" id="companyName" placeholder="Enter the name of the company" disabled>
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('title') ?>"
                               class="<?= !empty($errors['title']) ? 'error-border' : '' ?>" type="text" name="title"
                               id="title" placeholder="Enter a title for the task">
                    ...
                    <div class="form-input">
                        ...
                        <textarea rows="10" cols="45" id="description" name="description"
                                  placeholder="Describe your task"><?= set_value('description') ?></textarea>
                        <br>
                    ...
                    <div class="form-input">
                        ...
                        <input value="<?= set_value('value') ?>" type="number" name="value" id="value"
                    ...
                    <div class="form-input" style="display: flex;gap: 5px;">
                        <label for="isPdfRequiredProposal">Is document required to be submitted along with the proposal?
                            (check if true) :</label>
