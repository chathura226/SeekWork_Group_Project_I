...
<div class="pagetitle column-12">
      ...
      <nav>
        ...
        <ul class="breadcrumbs">
          ...
          <li class="breadcrumbs__item">
            <a href="<?=ROOT?>/<?=Auth::getrole()?>/tasks/<?=$task->taskID?>/view-proposals" class="breadcrumbs__link">Proposals</a>
          </li>
          <li class="breadcrumbs__item">
            <a href="" class="breadcrumbs__link breadcrumbs__link--active">Selcted a Proposal</a>
          </li>
        </ul>
      </nav>
</div><!-- End Page Title -->
...
<div class="task-details-wrapper column-12">
    ...
    <div class="about-task">
        ...
        <div class="about-task-item">
            ...
            <?php if(!empty($proposal->proposeAmount)) echo "Proposed Value: ".$proposal->proposeAmount."</br>"; else echo "Proposed Value: ".$task->value."</br>"; ?>
        </div>
        <div class="about-task-item">
    ...
    <div class="comp-details c-s-8 c-e-13">
        ...
        <?php if(!empty($student->description)):?>Description : <?=ucfirst($student->description)?><?php endif;?></br>
