...
<div class="best-part-cont" style="display: flex;width: 100%;margin: auto;align-items: center">
    <img style="object-fit: cover;width: 100%" src="<?=ROOT?>/assets/images/slider/test1.jpg" >
</div>
<div class="best-part-cont" style="display: flex;width: 100%;margin: auto;align-items: center">
    <img style="object-fit: cover;width: 100%" src="<?=ROOT?>/assets/images/slider/test2.jpg" >
</div>
<div class="best-part-cont" style="display: flex;width: 80%;margin: auto;align-items: center">
    <div class="best-part" >
        <h1 style="font-size: 2.75rem">The best part? Everything.</h1>
        <ul>
            <li>
                <h2 style="font-size: 1.5rem"><span class="" style="width:24px;height:24px;fill:#7A7D85;margin-right: 10px" aria-hidden="true"><svg
                ...
                <p style="margin-left:25px;font-size: 1rem">Find the right service for every price point. No hourly rates, just project-based
                    pricing.</p></li>
            <li>
                <h2 style="font-size: 1.5rem"><span class="" style="width:24px;height:24px;fill:#7A7D85;margin-right: 10px" aria-hidden="true"><svg
                                width="22" height="22" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path
                ...
                <p style="margin-left:25px;font-size: 1rem">Hand your project over to a talented freelancer in minutes, get long-lasting results.</p>
            </li>
            <li>
                <h2 style="font-size: 1.5rem"><span class="" style="width:24px;height:24px;fill:#7A7D85;margin-right: 10px" aria-hidden="true"><svg
                                width="22" height="22" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path
                ...
                <p style="margin-left:25px;font-size: 1rem">Upfront quotes mean no surprises. Payments only get released when you approve.</p></li>
            <li>
                <h2 style="font-size: 1.5rem"><span class="" style="width:24px;height:24px;fill:#7A7D85;margin-right: 10px" aria-hidden="true"><svg
                                width="22" height="22" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path
                                    d="M8 1.75C4.54822 1.75 1.75 4.54822 1.75 8C1.75 11.4518 4.54822 14.25 8 14.25C11.4518 14.25 14.25 11.4518 14.25 8C14.25 4.54822 11.4518 1.75 8 1.75ZM0.25 8C0.25 3.71979 3.71979 0.25 8 0.25C12.2802 0.25 15.75 3.71979 15.75 8C15.75 12.2802 12.2802 15.75 8 15.75C3.71979 15.75 0.25 12.2802 0.25 8Z"></path><path
                ...
                <p style="margin-left:25px;font-size: 1rem">Our round-the-clock support team is available to help anytime, anywhere.</p></li>
        </ul>
    </div>
