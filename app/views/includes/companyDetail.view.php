...
<div class="comp-details c-s-8 c-e-13">
    ...
    <?php if(!empty($createdAt)):?>Joined Date: <?= $createdAt ?></br><?php endif;?>
</div>
<?php else:?>
     <div class="comp-details c-s-8 c-e-13">
         <h2>About the company</h2>
