<?php $this->view('moderator/moderator-header', $data) ?>
    ...
    <div class="pagetitle column-12">
        ...
        <nav>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="breadcrumbs__item">
                    <a href="<?= ROOT ?>/moderator/supports" class="breadcrumbs__link">Supports</a>
                </li>
                <li class="breadcrumbs__item">
    ...
    <div class="task-details column-7">
        <h2>Support Request Description</h2>
        <hr><br>

        <h4>Request Subject:</h4>
        <div class="task-description" style="padding-left: 20px;">
            <?= $support->subject ?>
            <br>
        </div>
        ...
        <br><br>
        <h2>Support Requested Person Details:</h2>
<hr><br>
        <h4>Name</h4>
        <div class="task-description" style="padding-left: 20px;">
            <?= ucfirst($support->name) ?>
            <br>
        </div>
        <h4>Email Address</h4>
        <div class="task-description" style="padding-left: 20px;">
        ...
        <div class="about-task">
            <h2>About the Support Request</h2>
            ...
            <div class="about-task-item">
                ...
                Support Request Resolved Date
                : <?php if ($support->status === 'pending') echo "Support Request is still Pending </br>"; else echo $support->resolvedDate . "</br>"; ?>
            </div>
    ...
    <?php else: ?>
        <div class="task-details column-5">
            ...
            <div class="task-description">
                ...
                You already <span
                        style="color: <?= ($support->status == 'resolved') ? 'green' : 'red' ?>">resolved</span>
                this support request on <?= $support->resolvedDate ?>.
                <br>
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <textarea rows="10" cols="45" id="moderatorComment" name="moderatorComment"
                                                  placeholder="Enter  Comments about the support request resolution"
                                                  required></textarea>
                                        <br>
    ...
    <script>
        ...
        function resolvedDispute(e, submissionID) {
            popup_header.innerHTML = "Resolve Support Request";
