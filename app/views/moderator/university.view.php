...
<div class="pagetitle column-12">
      ...
      <nav>
        ...
        <ul class="breadcrumbs">
          ...
          <li class="breadcrumbs__item">
            <a href="<?=ROOT?>/moderator/university" class="breadcrumbs__link breadcrumbs__link--active">University</a>
          </li>
        </ul>
      </nav>
</div><!-- End Page Title -->
...
<div class="flex justify-between">
  <a href="<?=ROOT?>/moderator/university/modify/<?=$university->universityID?>">
    ...
    <button class="details-button margin-5 deletebttn"  data-id="<?=$university->universityID?>">
      Delete
      <div class="arrow-wrapper">
          <div class="arrow"></div>
      </div>
...
function sendActionToCurrentURL(action,id) {
        ...
        form.method = "POST";
        form.action = `<?=ROOT?>/moderator/university/delete/${id}`; // Use the current URL
