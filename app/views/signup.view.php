...
<link href="<?=ROOT?>/assets/css/passwordStrength.styles.css" rel="stylesheet">
...
<script type="text/javascript" src="<?=ROOT?>/assets/js/passwordStrength.js"></script>
