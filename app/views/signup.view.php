    ...
    <div class="form-wrap column-12">
        <div class="tab-form row-10">
            <div class="tab-header">
                ...
                } else echo 'active'; ?>">As a Student
                </div>
                <div class="<? if (!empty($errors['form_id'])) {
                    if ($errors['form_id'] === 'company') {
                        echo 'active';
                    } else echo '';
                } else echo ''; ?>">As a company
                </div>
            </div>
            <div class="tab-body">
                <div class="<? if (!empty($errors['form_id'])) {
                    ...
                    <form method="post">
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('email') ?>"
                                   ...
                                   name="email" id="email" placeholder="Enter your university student email address">
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('contactNo') ?>"
                                   class="<?= !empty($errors['contactNo']) ? 'error-border' : '' ?>" type="tel"
                        ...
                        <div class="form-input">
                            ...
                            <div class="strength-pass">
                                ...
                                <input value="<?= set_value('password') ?>"
                                       class="<?= !empty($errors['password']) ? 'error-border' : '' ?>" type="password"
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('rePassword') ?>"
                                   class="<?= !empty($errors['rePassword']) ? 'error-border' : '' ?>" type="password"
                        ...
                        <span> </br>By clicking sign-up you are agreeing to the <a rel="terms" href="<?= ROOT ?>/terms"
                                                                                   class='terms'>terms</a> of use and acknowledging the privacy policies.</span>
                    ...
                    <form method="post">
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('website') ?>"
                                   class="<?= !empty($errors['website']) ? 'error-border' : '' ?>" type="text"
                                   name="website" id="website" placeholder="Enter company website URL if available">
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('brn') ?>"
                                   class="<?= !empty($errors['brn']) ? 'error-border' : '' ?>" type="text" name="brn"
                        ...
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('firstName') ?>"
                                   class="<?= !empty($errors['firstName']) ? 'error-border' : '' ?>" type="text"
                                   name="firstName" id="firstName" placeholder="Enter first name of contact person">
                            <?php if (!empty($errors['firstName'])) : ?>
                                <div class="text-error"><small><?= $errors['firstName'] ?></small></div>
                            <?php endif; ?>
                        </div>
                        <div class="form-input">
                            ...
                            <input value="<?= set_value('lastName') ?>"
                                   class="<?= !empty($errors['lastName']) ? 'error-border' : '' ?>" type="text"
                                   name="lastName" id="lastName" placeholder="Enter last name of contact person">
                            <?php if (!empty($errors['lastName'])) : ?>
                                <div class="text-error"><small><?= $errors['lastName'] ?></small></div>
                            <?php endif; ?>
                        </div>
