        ...
        <div class="btn-container c-s-8 c-e-13">
            <div class="btn-effect">
                ...
                <?php if ($task->status === 'closed') : ?>
                    ...
                    <a class="effect" href="<?= ROOT ?>/student/review/post/<?= $task->taskID ?>" title="Add a Review">Add
                        a Review</a>
                <?php endif; ?>
                <?php if ($task->status === 'closed') : ?>
                ...
                <a class="effect" href="<?= ROOT ?>/student/chats/<?= $company->userID ?>" title="Chat now">Chat Now</a>
