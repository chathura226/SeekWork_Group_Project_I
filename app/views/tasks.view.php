  ...
  <div class="task-wrapper column-12">
      ...
      <?php foreach ($tasks as $task) : ?>
          ...
          <div class="post-container" id="$task->taskID">
              ...
              <div class="task-disc">
                  <div style="max-height: 45px; max-width:45px;margin:0;padding:0; display:flex; flex-wrap:wrap; justify-content:center;">
                  <img src="<?= ROOT ?><?= (!empty($task->profilePic)) ? "/" . $task->profilePic : "/assets/images/noImage.png" ?>" alt="Profile Picture">
                  </div>
